...
- [Rego Policy Libraries](https://github.com/ynotbhatc/rego_policy_libraries) - 600+ production-ready Rego v1 policies for CIS Benchmarks, DISA STIGs, NIST, NERC-CIP, IEC 62443, ISO 27001, SOC 2, PCI-DSS, EU AI Act, and 55+ frameworks. Vendor-neutral, fail-closed, Apache 2.0, with OCI bundle distribution.
